...
[ -f "./Clash-Windows.7z" ] && mv -vf Clash-Windows.7z ./deploy/Clash-Windows.7z
rm -rf Clash-Windows
...
[ -f "./ClashX.dmg" ] && mv -vf ClashX.dmg ./deploy/ClashX.dmg
...
[ -f "./ss-android.apk" ] && mv -vf ss-android.apk ./deploy/ss-android.apk
...
[ -f "ss-win.zip" ] && mv -vf ss-win.zip ./deploy/ss-win.zip
...
[ -f "ss-mac.zip" ] && mv -vf ss-mac.zip ./deploy/ss-mac.zip
...
[ -f "ssd-android.apk" ] && mv -vf ssd-android.apk ./deploy/ssd-android.apk
...
[ -f "ssd-win.7z" ] && mv -vf ssd-win.7z ./deploy/ssd-win.7z
...
[ -f "ssrr-android.apk" ] && mv -vf ssrr-android.apk ./deploy/ssrr-android.apk
